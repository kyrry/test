...
let tryGeetest = function (callback, config) {
    setTimeout(() => {
        try {
...
window.initGeetest = function (userConfig, callback) {
    ...
    // for KFC
    if ('050cffef4ae57b5d5e529fea9540b0d1' === userConfig.gt ||
        '3bd38408ae4af923ed36e13819b14d42' === userConfig.gt) {
